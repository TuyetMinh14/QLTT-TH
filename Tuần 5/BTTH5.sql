...
INSERT INTO KhoaHoc
    (TenKhoaHoc)
SELECT 'Mang May Tinh Truyen Thong'
INSERT INTO KhoaHoc
    (TenKhoaHoc)
SELECT 'Khoa Hoc May Tinh'
INSERT INTO KhoaHoc
    (TenKhoaHoc)
SELECT 'Ky Thuat May Tinh'
-- SinhVien
...
INSERT INTO MonHoc
    (TenMonHoc)
SELECT ('Co So Du Lieu')
INSERT INTO MonHoc
    (TenMonHoc)
SELECT ('Cau Truc Du Lieu')
INSERT INTO MonHoc
    (TenMonHoc)
SELECT ('Lap Trinh Di Dong')
INSERT INTO MonHoc
    (TenMonHoc)
SELECT ('Toan Giai Tich')
INSERT INTO MonHoc
    (TenMonHoc)
SELECT ('Lap Trinh Java')
INSERT INTO MonHoc
    (TenMonHoc)
SELECT ('He Quan Tri CSDL')
INSERT INTO MonHoc
    (TenMonHoc)
SELECT ('Anh Van')
INSERT INTO MonHoc
...
SELECT ChitietSV.query('for $i in /THONGTINSV/sinhvien let $j := $i where ($j/@ID) < 12 return $j')
FROM QuanLySV
where MSDH = 1
...
WHERE TenDH = 'DH KHTN'
SELECT ChiTietSV.query('/THONGTINSV/*') FROM QuanLySV WHERE TenDH = 'DH CNTT'

--Câu 7: Viết lệnh Xquery trả về thông tin các sinh viên có tên là ‘Nam’ hoặc ‘Thanh’.
SELECT ChitietSV.query('for $i in /THONGTINSV/sinhvien let $j := $i where ($j/@ten = "Nam" or $j/@ten = "Thanh") return $j')
FROM QuanLySV
...
SELECT ChiTietSV.exist('//sinhvien[@ID=12]') as TonTaiSV_ID12
FROM QuanLySV
WHERE TenDH = 'DH KHTN'
...
SELECT ChiTietSV.exist('//sinhvien[@Ten="Lan"]') as TonTaiSV_ID12
FROM QuanLySV
WHERE TenDH = 'DH CNTT'

UPDATE QuanLySV 
SET ChiTietSV.modify('insert(<THONGTINSV>
<sinhvien ID="15" Ten="Lan">
<monhoc ID="10" Ten="Toan Roi Rac" />
<monhoc ID="11" Ten="Lap Trinh C#" />
<monhoc ID="12" Ten="CSDL Nang Cao" />
</sinhvien>
</THONGTINSV>) into (/THONGTINSV)[1]')
...
SELECT SinhVien.TenSV AS TENSINHVIEN, KhoaHoc.TenKhoaHoc AS TENKHOAHOC FROM SinhVien, KhoaHoc 
WHERE SinhVien.MaKhoaHoc = KhoaHoc.MaKhoaHoc
